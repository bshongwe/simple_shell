...
/**
 * dequote - func dequotes str
 * @str: str
 * Return: malloc fail (NULL), otherwise return dequoted str copy
 */
...
/**
 * dequote_len - func computes str len after dequoting
 * @str: str input
 * Return: str len after dequoting
 */
