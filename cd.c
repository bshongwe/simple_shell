...
/**
 * cd_to_home - func changes to home directory
...
/**
 * cd_previous - func changes to previous directory
 * @datash: data relevant (env)
 * 
 * Return: no return
 */
...
/**
 * cd_dot - func changes to parent directory
...
/**
 * cd_to - func changes to given directory
