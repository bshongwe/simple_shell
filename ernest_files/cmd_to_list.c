...
/**
 * cmd_to_list - func constructs linked list of tokenized cmds
 * @cmd: cmd to parse
 * Return: If memory allocation fails, return NULL. Otherwise, return
...
/**
 * _cmd_to_list - helper func constructs linked list of tokenized cmds
